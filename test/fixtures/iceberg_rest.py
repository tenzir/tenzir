...
# Pinned to the Iceberg release version so catalog behavior only changes
# through a deliberate bump.
ICEBERG_REST_IMAGE = "docker.io/apache/iceberg-rest-fixture:1.10.1"
STARTUP_TIMEOUT = 60
