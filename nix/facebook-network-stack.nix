{
  ...
  fizz = {
    ...
    hash = "sha256-JS7UX/ilrFV1BvdW45uj+MGz6PdhKNh162es/khQOMQ=";
  };
  wangle = {
    owner = "facebook";
    repo = "wangle";
    rev = "74b02bbfb8237c1ada5c0c592a535fd3b90ef460";
    hash = "sha256-4upeE8XiVPWb19y6DL+GGKkxcFDdvOfUjGoy3LkqNwM=";
  };
  mvfst = {
    owner = "facebook";
    repo = "mvfst";
    rev = "0564d5c495cc3281d79d70563fd9e5d57dadf050";
    hash = "sha256-h0jfadP/c8dg4df9r5K48fJ9a0XpUEoSQHvIrdYdagU=";
  };
  proxygen = {
    owner = "tenzir";
    repo = "proxygen";
