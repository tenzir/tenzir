...
buffered_input_stream::buffered_input_stream(input_device& idev,
                                             size_t block_size)
  : buffer_(block_size > 0 ? block_size : default_block_size), idev_{&idev} {
}
...
buffered_output_stream::buffered_output_stream(output_device& odev,
                                               size_t block_size)
  : buffer_(block_size > 0 ? block_size : default_block_size), odev_{&odev} {
}
