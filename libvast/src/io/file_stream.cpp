...
file_input_device::file_input_device(path const& filename) : file_(filename) {
...
file_input_stream::file_input_stream(path const& filename, size_t block_size)
  : buffer_(filename), buffered_stream_(buffer_, block_size) {
}

file_input_stream::file_input_stream(file::native_type handle,
                                     bool close_behavior, size_t block_size)
  : buffer_(handle, close_behavior), buffered_stream_(buffer_, block_size) {
}
...
file_output_device::file_output_device(path const& filename) : file_(filename) {
...
file_output_stream::file_output_stream(file::native_type handle,
                                       bool close_behavior, size_t block_size)
  : buffer_(handle, close_behavior), buffered_stream_(buffer_, block_size) {
}
