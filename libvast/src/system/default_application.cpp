...
default_application::default_application() {
  ...
  add("version", opts())
    ...
    ->run(version_command);
  add("start", opts())->describe("starts a node")->run(start_command);
  add("stop", opts())->describe("stops a node")->run(remote_command);
  add("spawn", opts())->describe("creates a new component")->run(remote_command);
  add("kill", opts())->describe("terminates a component")->run(remote_command);
  add("peer", opts())->describe("peers with another node")->run(remote_command);
  add("status", opts())
