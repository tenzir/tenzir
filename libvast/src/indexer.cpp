      ...
      auto result = caf::attach_stream_sink(
        ...
        [self, id = self->id()](caf::unit_t&, const caf::error& err) {
          ...
          if (err) {
            ...
            TENZIR_ERROR("indexer got a stream error: {}", render(err));
            return;
          }
