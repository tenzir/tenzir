...
CAF_BEGIN_TYPE_ID_BLOCK(vast_atoms, caf::id_block::vast_types::end)
  ...
  VAST_ADD_ATOM(http_request, "hrequest")
  ...
  VAST_ADD_ATOM(proxy, "proxy")
  VAST_ADD_ATOM(pull, "pull")
  VAST_ADD_ATOM(push, "push")
