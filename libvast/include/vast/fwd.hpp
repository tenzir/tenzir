...
#define TENZIR_ADD_TYPE_ID(type) CAF_ADD_TYPE_ID(vast_types, type)
...
CAF_BEGIN_TYPE_ID_BLOCK(vast_types, first_vast_type_id)
  ...
  TENZIR_ADD_TYPE_ID((vast::bitmap))
  TENZIR_ADD_TYPE_ID((vast::chunk_ptr))
  TENZIR_ADD_TYPE_ID((vast::conjunction))
  TENZIR_ADD_TYPE_ID((vast::count_query_context))
  TENZIR_ADD_TYPE_ID((vast::curried_predicate))
  TENZIR_ADD_TYPE_ID((vast::data))
  TENZIR_ADD_TYPE_ID((vast::data_extractor))
  TENZIR_ADD_TYPE_ID((vast::diagnostic))
  TENZIR_ADD_TYPE_ID((vast::disjunction))
  TENZIR_ADD_TYPE_ID((vast::ec))
  TENZIR_ADD_TYPE_ID((vast::ewah_bitmap))
  TENZIR_ADD_TYPE_ID((vast::expression))
  TENZIR_ADD_TYPE_ID((vast::extract_query_context))
  TENZIR_ADD_TYPE_ID((vast::field_extractor))
  TENZIR_ADD_TYPE_ID((vast::http_request_description))
  TENZIR_ADD_TYPE_ID((vast::invocation))
  TENZIR_ADD_TYPE_ID((vast::ip))
  TENZIR_ADD_TYPE_ID((vast::meta_extractor))
  TENZIR_ADD_TYPE_ID((vast::module))
  TENZIR_ADD_TYPE_ID((vast::negation))
  TENZIR_ADD_TYPE_ID((vast::null_bitmap))
  TENZIR_ADD_TYPE_ID((vast::operator_box))
  TENZIR_ADD_TYPE_ID((vast::operator_type))
  TENZIR_ADD_TYPE_ID((vast::partition_info))
  TENZIR_ADD_TYPE_ID((vast::partition_synopsis_pair))
  TENZIR_ADD_TYPE_ID((vast::partition_synopsis_ptr))
  TENZIR_ADD_TYPE_ID((vast::pattern))
  TENZIR_ADD_TYPE_ID((vast::pipeline))
  TENZIR_ADD_TYPE_ID((vast::port))
  TENZIR_ADD_TYPE_ID((vast::port_type))
  TENZIR_ADD_TYPE_ID((vast::predicate))
  TENZIR_ADD_TYPE_ID((vast::qualified_record_field))
  TENZIR_ADD_TYPE_ID((vast::query_context))
  TENZIR_ADD_TYPE_ID((vast::query_options))
  TENZIR_ADD_TYPE_ID((vast::relational_operator))
  TENZIR_ADD_TYPE_ID((vast::rest_endpoint))
  TENZIR_ADD_TYPE_ID((vast::rest_response))
  TENZIR_ADD_TYPE_ID((vast::subnet))
  TENZIR_ADD_TYPE_ID((vast::table_slice))
  TENZIR_ADD_TYPE_ID((vast::table_slice_column))
  TENZIR_ADD_TYPE_ID((vast::taxonomies))
  TENZIR_ADD_TYPE_ID((vast::type))
  TENZIR_ADD_TYPE_ID((vast::type_extractor))
  TENZIR_ADD_TYPE_ID((vast::type_set))
  TENZIR_ADD_TYPE_ID((vast::uuid))
  TENZIR_ADD_TYPE_ID((vast::wah_bitmap))

  TENZIR_ADD_TYPE_ID((vast::tag<vast::table_slice>))
  TENZIR_ADD_TYPE_ID((vast::tag<vast::chunk_ptr>))
  ...
  TENZIR_ADD_TYPE_ID((std::vector<vast::data>))
  TENZIR_ADD_TYPE_ID((vast::detail::stable_map<std::string, vast::data>))
  TENZIR_ADD_TYPE_ID((vast::detail::stable_map<vast::data, vast::data>))

  TENZIR_ADD_TYPE_ID((vast::connect_request))
  TENZIR_ADD_TYPE_ID((vast::metrics_metadata))
  TENZIR_ADD_TYPE_ID((vast::performance_report))
  TENZIR_ADD_TYPE_ID((vast::query_cursor))
  TENZIR_ADD_TYPE_ID((vast::query_status))
  TENZIR_ADD_TYPE_ID((vast::report))
  TENZIR_ADD_TYPE_ID((vast::keep_original_partition))
  TENZIR_ADD_TYPE_ID((vast::status_verbosity))
  TENZIR_ADD_TYPE_ID((vast::catalog_lookup_result))
  TENZIR_ADD_TYPE_ID((vast::accountant_config))
  TENZIR_ADD_TYPE_ID((vast::send_initial_dbstate))

  TENZIR_ADD_TYPE_ID((vast::framed<vast::chunk_ptr>))
  TENZIR_ADD_TYPE_ID((vast::framed<vast::table_slice>))
  TENZIR_ADD_TYPE_ID((std::pair<std::string, vast::data>))
  TENZIR_ADD_TYPE_ID((std::vector<uint32_t>))
  TENZIR_ADD_TYPE_ID((std::vector<uint64_t>))
  TENZIR_ADD_TYPE_ID((std::vector<std::string>))
  TENZIR_ADD_TYPE_ID((std::vector<vast::chunk_ptr>))
  TENZIR_ADD_TYPE_ID((std::tuple<std::string, std::vector<vast::table_slice>>))
  TENZIR_ADD_TYPE_ID((std::vector<vast::table_slice>))
  TENZIR_ADD_TYPE_ID((std::vector<vast::framed<vast::chunk_ptr>>))
  TENZIR_ADD_TYPE_ID((std::vector<vast::framed<vast::table_slice>>))
  TENZIR_ADD_TYPE_ID((std::vector<vast::table_slice_column>))
  TENZIR_ADD_TYPE_ID((std::vector<vast::uuid>))
  TENZIR_ADD_TYPE_ID((std::vector<vast::partition_info>))
  TENZIR_ADD_TYPE_ID(
    (std::unordered_map<vast::uuid, vast::partition_synopsis_ptr>))
  TENZIR_ADD_TYPE_ID((std::unordered_map<vast::type, //
                                         vast::catalog_lookup_result>))
  TENZIR_ADD_TYPE_ID((std::map<vast::uuid, vast::partition_synopsis_ptr>))
  TENZIR_ADD_TYPE_ID(
    (std::shared_ptr<
      std::unordered_map<vast::uuid, vast::partition_synopsis_ptr>>))
  TENZIR_ADD_TYPE_ID((std::vector<vast::partition_synopsis_pair>))

  TENZIR_ADD_TYPE_ID((caf::stream<vast::chunk_ptr>))
  TENZIR_ADD_TYPE_ID((caf::stream<vast::table_slice>))
  TENZIR_ADD_TYPE_ID((caf::stream<vast::framed<vast::chunk_ptr>>))
  TENZIR_ADD_TYPE_ID((caf::stream<vast::framed<vast::table_slice>>))
  TENZIR_ADD_TYPE_ID((caf::stream<vast::table_slice_column>))
  TENZIR_ADD_TYPE_ID((caf::inbound_stream_slot<vast::chunk_ptr>))
  TENZIR_ADD_TYPE_ID((caf::inbound_stream_slot<vast::table_slice>))
  TENZIR_ADD_TYPE_ID((caf::inbound_stream_slot<vast::framed<vast::chunk_ptr>>))
  TENZIR_ADD_TYPE_ID(
    (caf::inbound_stream_slot<vast::framed<vast::table_slice>>))
  TENZIR_ADD_TYPE_ID((caf::inbound_stream_slot<vast::table_slice_column>))
  TENZIR_ADD_TYPE_ID((caf::outbound_stream_slot<vast::table_slice>))
