...
inline constexpr std::string_view db_directory = "vast.db";
...
inline constexpr caf::timespan active_partition_timeout = std::chrono::hours{1};
...
inline constexpr const char* store_backend = "segment-store";
