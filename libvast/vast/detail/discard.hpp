...
#define VAST_DISCARD_2(m1, m2) VAST_DISCARD_1((m1)), VAST_DISCARD_1((m2))
...
#define VAST_DISCARD_5(m1, m2, m3, m4, m5)                                     \
  VAST_DISCARD_1((m1)), VAST_DISCARD_1((m2)), VAST_DISCARD_1((m3)),            \
    VAST_DISCARD_1((m4)), VAST_DISCARD_1((m5))
#define VAST_DISCARD_6(m1, m2, m3, m4, m5, m6)                                 \
  VAST_DISCARD_1((m1)), VAST_DISCARD_1((m2)), VAST_DISCARD_1((m3)),            \
    VAST_DISCARD_1((m4)), VAST_DISCARD_1((m5)), VAST_DISCARD_1((m6))
...
#define VAST_DISCARD_9(m1, m2, m3, m4, m5, m6, m7, m8, m9)                     \
  VAST_DISCARD_1((m1)), VAST_DISCARD_1((m2)), VAST_DISCARD_1((m3)),            \
    VAST_DISCARD_1((m4)), VAST_DISCARD_1((m5)), VAST_DISCARD_1((m6)),          \
    VAST_DISCARD_1((m7)), VAST_DISCARD_1((m8)), VAST_DISCARD_1((m9))
...
#define VAST_DISCARD_11(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11)          \
  VAST_DISCARD_1((m1)), VAST_DISCARD_1((m2)), VAST_DISCARD_1((m3)),            \
    VAST_DISCARD_1((m4)), VAST_DISCARD_1((m5)), VAST_DISCARD_1((m6)),          \
    VAST_DISCARD_1((m7)), VAST_DISCARD_1((m8)), VAST_DISCARD_1((m9)),          \
    VAST_DISCARD_1((m10)), VAST_DISCARD_1((m11))
