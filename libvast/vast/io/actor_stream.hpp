#ifndef VAST_IO_ACTOR_STREAM_HPP
#define VAST_IO_ACTOR_STREAM_HPP
...
#include "vast/io/buffered_stream.hpp"
...
public:
  ...
  actor_input_stream(actor source, std::chrono::milliseconds timeout);
...
public:
  ...
  actor_output_device(actor sink);
...
public:
  ...
  actor_output_stream(actor sink, size_t block_size = 0);
