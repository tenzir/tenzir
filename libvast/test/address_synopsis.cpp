...
TEST(construction via custom factory) {
  ...
  verify(to_addr_view("192.168.0.1"), {N, N, N, N, T, N, N, N, N, N});
  MESSAGE("collisions");
  verify(to_addr_view("192.168.0.6"), {N, N, N, N, F, N, N, N, N, N});
  verify(to_addr_view("192.168.0.11"), {N, N, N, N, T, N, N, N, N, N});
}
