...
//   const auto* plugin =
//   vast::plugins::find<vast::store_actor_plugin>("feather"); REQUIRE(plugin);
...
//     map{{pattern("l64"),
//     unbox(to<subnet>("ff01:db8::202:b3ff:fe1e:8329/64"))},
//         {pattern("l96"),
//         unbox(to<subnet>("ff01:db8::202:b3ff:fe1e:8329/96"))},
...
//   vast::plugins::find<vast::store_actor_plugin>("feather"); REQUIRE(plugin);
//   auto builder_and_header
//     = plugin->make_store_builder(accountant, filesystem,
//     vast::uuid::random());
//   REQUIRE_NOERROR(builder_and_header);
//   auto& [builder, header] = *builder_and_header;
//   auto slices = std::vector<table_slice>{slice};
