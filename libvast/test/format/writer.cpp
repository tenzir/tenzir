...
auto last_bro_http_log_line = R"__(bro::http [19481|+1258617362396400896ns] [+1258617362396400896ns, "aRcY4DjxcQ5", [192.168.1.103, 1232/?, 87.106.12.47, 80/?], 1, "POST", "87.106.12.47", "/rpc.html?e=bl", nil, "SCSDK-6.0.0", 992, 96, 200, "OK", nil, nil, nil, {}, nil, nil, nil, "application/octet-stream", nil, nil])__";
...
auto last_csv_http_log_line = R"__(bro::http,19481,1258617362396400896,+1258617362396400896ns,"aRcY4DjxcQ5",192.168.1.103,1232/?,87.106.12.47,80/?,1,"POST","87.106.12.47","/rpc.html?e=bl",,"SCSDK-6.0.0",992,96,200,"OK",,,,"",,,,"application/octet-stream",,)__";

auto first_ascii_bgpdump_txt_line = R"__(bgpdump::state_change [19482|+1408579214000000000ns] [+1408579214000000000ns, 2a02:20c8:1f:1::4, 50304, "3", "2"])__";
