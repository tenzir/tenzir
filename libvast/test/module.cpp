...
TEST(YAML Module - minima suricata sample) {
  auto s
    = "#module: suricata\n"
      ...
      "        - ftp:\n"
      "            record:\n"
      "              - command: vast.string_id\n"
      "              - command_data: vast.string_id\n"
      "              - reply:\n"
      "                  list: string\n"
      "              - completion_code:\n"
      "                  list: string\n"
      ...
      "              - md5: vast.string_id\n"
      "              - sha1: vast.string_id\n"
      "              - sha256: vast.string_id\n"
      "              - stored: bool\n"
      "              - file_id: vast.count_id\n"
      "              - size: count\n"
      "              - tx_id: vast.count_id\n"
      "        - http:\n"
      "            record:\n"
