...
@test "YAML" {
  ...
  check tenzir 'config | drop tenzir.config, tenzir.cacert, tenzir.cache-directory, tenzir.metrics, tenzir.state-directory, tenzir.start, tenzir.endpoint | write yaml'
