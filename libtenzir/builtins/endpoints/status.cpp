...
namespace tenzir::plugins::rest_api::status {
...
auto status_handler(
  ...
  return {
    [self](atom::http_request, uint64_t,
           const tenzir::record& params) -> caf::result<rest_response> {
...
TENZIR_REGISTER_PLUGIN(tenzir::plugins::rest_api::status::plugin)
