...
TENZIR_INSTANTIATE_ARRAY_DATA_MEMBERS(Secret);
...
TENZIR_INSTANTIATE_DATA_TYPE_MEMBERS(Secret);
...
TENZIR_INSTANTIATE_ERASED_ARRAY_GET(13);
...
TENZIR_INSTANTIATE_DATA_ARRAY_GET(14);
