...
template auto run_chain(OperatorChain<void, table_slice> chain,
...
template auto run_chain(OperatorChain<chunk_ptr, table_slice> chain,
...
template auto run_chain(OperatorChain<table_slice, table_slice> chain,
