    ...
    static auto apply_transformation(ecc::cleansing_blob blob,
      ...
      switch (operation) {
        ...
        case decode_base64: {
          ...
          blob.assign(reinterpret_cast<const std::byte*>(decoded->data()),
        ...
        case encode_base64: {
          ...
          blob.assign(reinterpret_cast<const std::byte*>(encoded.data()),
    ...
    auto finish(const request_map_t& requested,
      ...
      const auto f = detail::overload{
        ...
        [](const fbs::data::SecretLiteral& l) -> ret_t {
          ...
          const auto begin = reinterpret_cast<const std::byte*>(v.data());
          const auto end = begin + v.size();
          return ecc::cleansing_blob{begin, end};
        },
