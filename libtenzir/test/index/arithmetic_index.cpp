...
TEST(duration) {
  ...
  auto idx = arithmetic_index<tenzir::duration>{type{duration_type{}}, opts};
  MESSAGE("append");
...
TEST(time) {
  caf::settings opts;
  opts["base"] = "uniform64(10)";
  arithmetic_index<tenzir::time> idx{type{time_type{}}, opts};
  auto ts = to<tenzir::time>("2014-01-16+05:30:15");
  MESSAGE("append");
  REQUIRE(idx.append(make_data_view(unbox(ts))));
  ts = to<tenzir::time>("2014-01-16+05:30:12");
  REQUIRE(idx.append(make_data_view(unbox(ts))));
  ts = to<tenzir::time>("2014-01-16+05:30:15");
  REQUIRE(idx.append(make_data_view(unbox(ts))));
  ts = to<tenzir::time>("2014-01-16+05:30:18");
  REQUIRE(idx.append(make_data_view(unbox(ts))));
  ts = to<tenzir::time>("2014-01-16+05:30:15");
  REQUIRE(idx.append(make_data_view(unbox(ts))));
  ts = to<tenzir::time>("2014-01-16+05:30:19");
  REQUIRE(idx.append(make_data_view(unbox(ts))));
  MESSAGE("lookup");
  ts = to<tenzir::time>("2014-01-16+05:30:15");
  auto fifteen
  ...
  ts = to<tenzir::time>("2014-01-16+05:30:20");
  auto twenty
  ...
  caf::byte_buffer buf;
  CHECK(detail::serialize(buf, idx));
  arithmetic_index<tenzir::time> idx2{type{time_type{}}, opts};
