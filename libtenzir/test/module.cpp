...
caf::expected<type> to_map(std::string_view name, const data& map_to_parse,
  ...
  if (found_key == map_record.end() or found_value == map_record.end()) {
