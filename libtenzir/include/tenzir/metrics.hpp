...
struct [[nodiscard]] exec_node_metrics {
  ...
  friend auto inspect(Inspector& f, exec_node_metrics& x) -> bool {
    return f.object(x)
      .pretty_name("exec_node_metrics")
      .fields(f.field("time_starting", x.time_starting),
