...
/// returns a `failure`, execution will not continue after the secret resolution.
using secret_request_callback
  = std::function<failure_or<void>(resolved_secret_value value)>;
