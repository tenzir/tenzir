...
// [[nodiscard]] auto
// assign(const ast::selector& left, multi_series right, const table_slice&
// input,
...
// [[nodiscard]] auto assign(const ast::simple_selector& left, multi_series
// right,
//                           const table_slice& input, diagnostic_handler& dh,
//                           assign_position position = assign_position::back)
//   -> std::vector<table_slice>;

// TODO: Take multi series instead?
