...
public:
  ...
  virtual caf::error module(tenzir::module x) = 0;
  ...
  [[nodiscard]] virtual tenzir::report status() const;
...
public:
  reader_clock::duration batch_timeout_
    = tenzir::defaults::import::batch_timeout;
  reader_clock::duration read_timeout_ = tenzir::defaults::import::read_timeout;
