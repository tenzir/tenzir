...
private:
  ...
  [[nodiscard]] std::vector<const tenzir::fbs::FlatTableSlice*>
  flat_slices_() const;

  [[nodiscard]] tenzir::table_slice get_slice_(size_t idx) const;
