#ifndef VAST_CONCEPT_SERIALIZABLE_DATA_H
#define VAST_CONCEPT_SERIALIZABLE_DATA_H
...
#include "vast/concept/serializable/util/flat_set.h"
#include "vast/concept/serializable/util/none.h"
