#ifndef VAST_CONCEPT_PRINTABLE_VAST_BITVECTOR_H
#define VAST_CONCEPT_PRINTABLE_VAST_BITVECTOR_H
  ...
  : printer<bitvector_printer<BlockOrder, UnusedBit, BlockDivider>>
{
  ...
  static bool print_block(Iterator& out, Block block,
                          size_t from = 0, size_t to = bitvector::block_width)
  {
    while (from < to)
    {
      char c;
