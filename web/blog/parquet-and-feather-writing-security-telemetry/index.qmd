...
2. Writing Security Telemetry (this blog post)
3. TBD
...
all having the same schema. In Feather they are literally concatenated
sequentially, whereas Parquet concatenates them column-wise. Most stores only
consist of a few record batches. PCAP is the only difference.
...
compression means a shorter runtime.
