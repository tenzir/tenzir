...
# * Find PLASMA (plasma/client.h, libplasma.a, libplasma.so) This module defines
#   PLASMA_INCLUDE_DIR, directory containing headers PLASMA_LIBS, directory
#   containing plasma libraries PLASMA_STATIC_LIB, path to libplasma.a
#   PLASMA_SHARED_LIB, path to libplasma's shared library PLASMA_SHARED_IMP_LIB,
#   path to libplasma's import library (MSVC only) PLASMA_FOUND, whether plasma
#   has been found
...
if (PLASMA_FOUND)
  ...
  if (NOT Plasma_FIND_QUIETLY)
    ...
    set(PLASMA_ERR_MSG
        "${PLASMA_ERR_MSG} in ${PLASMA_SEARCH_HEADER_PATHS}, and for libs")
