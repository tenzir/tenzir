...
if (re2_FIND_VERSION)
  list(APPEND find_package_args ${re2_FIND_VERSION})
endif ()
if (re2_FIND_QUIETLY)
  list(APPEND find_package_args QUIET)
endif ()
set(_vast_cmake_module_path "${CMAKE_MODULE_PATH}")
unset(CMAKE_MODULE_PATH)
find_package(re2 ${find_package_args})
set(CMAKE_MODULE_PATH "${_vast_cmake_module_path}")
if (re2_FOUND)
  set(re2_FOUND TRUE)
  return()
endif ()
...
if (re2_FOUND)
  if (NOT TARGET re2::re2)
    ...
    set_target_properties(
      re2::re2 PROPERTIES IMPORTED_LOCATION "${RE2_LIB}"
