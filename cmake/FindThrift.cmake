...
#
# This module defines THRIFT_VERSION, version string of ant if found
# THRIFT_INCLUDE_DIR, where to find THRIFT headers THRIFT_STATIC_LIB, THRIFT
# static library THRIFT_FOUND, If false, do not try to use ant
...
function (EXTRACT_THRIFT_VERSION)
  exec_program(
    ...
    RETURN_VALUE
    THRIFT_RETURN)
  # We're expecting OUTPUT_VARIABLE to look like one of these: 0.9.3 Thrift
  # version 0.11.0
...
if (Thrift_ROOT)
  find_library(
    THRIFT_STATIC_LIB thrift${THRIFT_MSVC_STATIC_LIB_SUFFIX}
    PATHS ${Thrift_ROOT}
...
find_package_handle_standard_args(Thrift REQUIRED_VARS THRIFT_STATIC_LIB
...
if (Thrift_FOUND OR THRIFT_FOUND)
  ...
  set_target_properties(
    Thrift::thrift
    PROPERTIES
      IMPORTED_LOCATION "${THRIFT_STATIC_LIB}" INTERFACE_INCLUDE_DIRECTORIES
                                               "${THRIFT_INCLUDE_DIR}")
