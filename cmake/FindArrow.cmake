...
#   ARROW_INCLUDE_DIR, directory containing headers ARROW_LIBS, directory
#   containing arrow libraries ARROW_STATIC_LIB, path to libarrow.a
#   ARROW_SHARED_LIB, path to libarrow's shared library ARROW_SHARED_IMP_LIB,
#   path to libarrow's import library (MSVC only) ARROW_FOUND, whether arrow has
#   been found
...
if (MSVC)
  ...
  # Prioritize "/bin" over LIB_PATH_SUFFIXES - DLL files are installed in "/bin"
  # and static objects are in "/lib", so we want to search "/bin" first
  find_library(
    ARROW_SHARED_LIBRARIES
    NAMES arrow
    PATHS ${ARROW_HOME}
  ...
  find_library(
    ARROW_PYTHON_SHARED_LIBRARIES
    NAMES arrow_python
    PATHS ${ARROW_HOME}
    PATH_SUFFIXES "bin" ${LIB_PATH_SUFFIXES}
    NO_DEFAULT_PATH)
  get_filename_component(ARROW_SHARED_LIBS ${ARROW_SHARED_LIBRARIES} PATH)
  get_filename_component(ARROW_PYTHON_SHARED_LIBS
                         ${ARROW_PYTHON_SHARED_LIBRARIES} PATH)
endif ()
...
if (ARROW_FOUND)
  ...
  if (NOT Arrow_FIND_QUIETLY)
    ...
    set(ARROW_ERR_MSG
        "${ARROW_ERR_MSG} in ${ARROW_SEARCH_HEADER_PATHS}, and for libs")
...
if (MSVC)
  ...
  mark_as_advanced(ARROW_INCLUDE_DIR ARROW_STATIC_LIB ARROW_SHARED_LIB
                   ARROW_PYTHON_STATIC_LIB ARROW_PYTHON_SHARED_LIB)
endif ()
