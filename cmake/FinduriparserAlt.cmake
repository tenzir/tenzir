...
if (uriparser_ROOT)
  ...
  if (uriparserAlt_FIND_VERSION)
    set(uriparser_PC_MODULE
        "${uriparser_PC_MODULE} >= ${uriparserAlt_FIND_VERSION}")
  endif ()
...
if (NOT uriparser_VERSION AND uriparser_INCLUDE_DIR)
  file(READ "${uriparser_INCLUDE_DIR}/uriparser/UriBase.h"
       uriparser_URI_BASE_H_CONTENT)
  string(
    REGEX MATCH "#define URI_VER_MAJOR +[0-9]+"
          uriparser_MAJOR_VERSION_DEFINITION "${uriparser_URI_BASE_H_CONTENT}")
  string(REGEX REPLACE "^.+ +([0-9]+)$" "\\1" uriparser_MAJOR_VERSION
                       "${uriparser_MAJOR_VERSION_DEFINITION}")
  string(
    REGEX MATCH "#define URI_VER_MINOR +[0-9]+"
          uriparser_MINOR_VERSION_DEFINITION "${uriparser_URI_BASE_H_CONTENT}")
  string(REGEX REPLACE "^.+ +([0-9]+)$" "\\1" uriparser_MINOR_VERSION
                       "${uriparser_MINOR_VERSION_DEFINITION}")
  string(
    REGEX
      MATCH "#define URI_VER_RELEASE +[0-9]+"
...
find_package_handle_standard_args(
  uriparserAlt REQUIRED_VARS uriparser_LIB uriparser_INCLUDE_DIR VERSION_VAR
  uriparser_VERSION)
...
if (uriparserAlt_FOUND)
  ...
  set_target_properties(
    uriparser::uriparser
    PROPERTIES
      IMPORTED_LOCATION "${uriparser_LIB}"
