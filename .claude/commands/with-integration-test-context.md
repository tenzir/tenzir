---
name: Run a task with additional knowledge about the integration test framework
---

**Test Framework Architecture:**

The Tenzir integration testing framework uses `run.py` to execute TQL files and
compare their output against reference files. Tests are organized by functionality
in subdirectories.
...
1. **Test Creation**:
   ...
   - When adding tests for a feature that is already implemented:
